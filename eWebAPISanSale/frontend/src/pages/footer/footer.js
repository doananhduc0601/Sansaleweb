...
export default function footer() {
    return (
            ...
            <MDBCol md="3">
              ...
              <ul>
                <li className="list-unstyled">
                  <a href="#!"className="list-unstyled">Thẻ ưu đãi</a>
                </li>
                <li className="list-unstyled">
                  <a href="#!"className="list-unstyled">Trung tâm hổ trợ </a>
                </li>
                <li className="list-unstyled">
                  <a href="#!"className="list-unstyled">Hướng dẫn sử dụng</a>
                </li>
                <li className="list-unstyled">
                  <a href="#!"className="list-unstyled">Link vào Group hổ trợ</a>
                </li>
              </ul>
            </MDBCol>
            <MDBCol md="3">
              ...
              <ul className="list">
                <li className="list-unstyled">
                  <a className="list-unstyled" href="#!"><BsCursor/>  098999999</a>
                </li>
                <li className="list-unstyled">
                  <a className="list-unstyled" href="#!"><BsEnvelope/>  sansalehot@gmail.com </a>
                </li>
                <li className="list-unstyled" className="list-unstyled">
                  <a href="#!"className="list-unstyled"><BsBriefcase/> Nhóm DT</a>
                </li>
        ...
        <div className="footer-copyright text-center py-3 footer-home-bot">
          <MDBContainer fluid>
            &copy; {new Date().getFullYear()} Copyright: <a href=""> sansalehot@gmail.com </a>
          </MDBContainer>
        </div>
      </MDBFooter>
    );
