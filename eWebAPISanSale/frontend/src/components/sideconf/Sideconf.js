...
import TaskForm1 from "./component_category/TaskFormside";
import Control1 from "./component_category/Control1";
import TaskList1 from "./component_category/TaskListside";
...
export default function CategoryList() {
  ...
  const employeeAPI = (url = "https://localhost:5001/api/Slides/") => {
    return {
